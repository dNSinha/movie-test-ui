...
import { ADD_MOVIE } from '../api/Movies';
...
const AddMovie = () => {
    ...
    const [addMovie, { data, error }] = useMutation<AddMovieResponse>(ADD_MOVIE, { variables: { ...formData, actors: chips } });
    ...
    React.useEffect(() => {
        data?.addMovie?.id && navigate("/movies");
    }, [data?.addMovie?.id]);
            ...
            <Box
                ...
                <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }}>
                    <TextField margin="normal" required fullWidth id="movieName" onChange={handleChange}
                        ...
                        helperText={formError?.movieName} autoFocus
                    ...
                    <TextField margin="normal" required fullWidth onChange={handleChange}
                        ...
                        helperText={formError?.releaseDate}
